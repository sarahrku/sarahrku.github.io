...
\begin{verbatim}
##  [1] -1.1295010  1.2660040 -0.9078392  0.4705522  0.3508347  0.3288316
##  [7]  0.3503138  1.6829648 -1.2722558  0.7674048  0.5827377 -0.5539948
## [13]  0.1651226  1.1098807 -2.4127320 -0.3301219  0.1530181  0.1195577
## [19]  0.5372404  0.1433733 -0.2490627  0.2944050 -1.7550915 -0.4734600
## [25] -0.5021878
\end{verbatim}
...
\DocumentationTok{\#\# [1] {-}1.1295010  1.2660040 {-}0.9078392  0.4705522  0.3508347  0.3288316}
\FunctionTok{tail}\NormalTok{(x) }\CommentTok{\#sidste 6}
\DocumentationTok{\#\# [1]  0.1433733 {-}0.2490627  0.2944050 {-}1.7550915 {-}0.4734600 {-}0.5021878}
\NormalTok{x[}\DecValTok{1}\NormalTok{] }\CommentTok{\#første værdi}
\DocumentationTok{\#\# [1] {-}1.129501}
\NormalTok{x[}\FunctionTok{length}\NormalTok{(x)] }\CommentTok{\#sidste data point}
\DocumentationTok{\#\# [1] {-}0.5021878}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## [1] -0.05056022  0.15301813  1.68296477 -2.41273197  0.88092598  0.93857657
\end{verbatim}
...
## -2.41273 -0.50219  0.15302 -0.05056  0.47055  1.68296
\end{verbatim}
...
\textbf{1}) Lav quiz - ``Quiz - ggplot2 part 2''

\textbf{2}) (\emph{Factorer og plots})
...
\tightlist
\item
  Først tjek hvor mange unikke værdier er der i variablen \texttt{cyl}.
\item
...
\textbf{3}) \emph{Manuelt farver og punkter}
...
\textbf{4}) \emph{Histogram med facets}
...
\item
  Anvend \texttt{facet\_grid} for at adskille dit plot i tre på \texttt{species} (obs små bogstaver til forskel fra i datasættet \texttt{iris})
\item
  Giv en forskellige farve til hvert niveau i \texttt{species}
\item
...
\textbf{5}) \textbf{a)} Lave et density plot af \texttt{body\_mass\_g}.
...
\item
  Bruge \texttt{fill} til at opdele de tre plots efter variablen \texttt{sex}
\item
...
\textbf{c}) Kan du forklare hvorfor der er blank plotter i din grid? Eksperimenter med \texttt{facet\_wrap} i stedet for facet grid.
...
\begin{figure}
\centering
\includegraphics{visualisering_22_files/figure-latex/unnamed-chunk-204-1.pdf}
\caption{\label{fig:unnamed-chunk-204}Min løsning}
\end{figure}

\textbf{7}) \emph{Coordinate systemer}
...
\begin{figure}
\centering
\includegraphics{visualisering_22_files/figure-latex/unnamed-chunk-205-1.pdf}
\caption{\label{fig:unnamed-chunk-205}Min løsning}
\end{figure}
...
\textbf{8}) Lave boxplots af \texttt{body\_mass\_g} opdelte efter \texttt{species}.
...
\textbf{9}) \emph{Annotations}. \textbf{a}) Lav et scatter plot af \texttt{bill\_length\_mm} vs \texttt{bill\_depth\_mm}.
...
\includegraphics{visualisering_22_files/figure-latex/unnamed-chunk-210-1.pdf}

\textbf{10}) Valgfri: Lav et scatter plot og inddrag \texttt{?scale\_colour\_gradient2} (se fk. \url{https://michaeltoth.me/a-detailed-guide-to-ggplot-colors.html})
